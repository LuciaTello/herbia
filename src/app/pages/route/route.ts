...
import { PlaceAutocompleteComponent } from '../../directives/place-autocomplete.directive';
import { RouteMapComponent } from '../../components/route-map/route-map';
import { getRarity } from '../../utils/rarity';

@Component({
  selector: 'app-route',
  imports: [FormsModule, RouterLink, PhotoGalleryComponent, PlaceAutocompleteComponent, RouteMapComponent],
