...
export const ES: Translations = {
  ...
  route: {
    ...
    exhausted: 'Ya has descubierto todas las plantas disponibles en esta zona este mes. ¡Vuelve a tus balades anteriores para buscar las que aún no has encontrado, o inténtalo el mes que viene para nuevas especies!',
  ...
  myTreks: {
    ...
    reactivateTrek: 'Reactivar excursión',
  ...
  challenges: {
    ...
    lockedDescription: 'Alcanza el nivel Pousse aventurière (750 pts) para desbloquear este desafío.',
    start: '¡Empezar!',
    locked: 'Bloqueado',
  ...
  quizUnlockPopup: {
    ...
    message: 'Has alcanzado el nivel Pousse aventurière. ¡Ya puedes poner a prueba tus conocimientos en el quiz de plantas!',
    dismiss: '¡Genial!',
  },
  offline: {
    banner: 'Sin conexión',
    photoQueued: 'Foto guardada, se sincronizará más tarde.',
  ...
  sync: {
    title: 'Sincronizar',
    subtitle: (n) => `${n} foto${n !== 1 ? 's' : ''} pendiente${n !== 1 ? 's' : ''}`,
    syncButton: (n) => `Sincronizar ${n} foto${n !== 1 ? 's' : ''}`,
    progress: (current, total) => `Foto ${current} / ${total}`,
    identifying: 'Identificando...',
    addMatch: (pts) => `Añadir (+${pts} pts)`,
    addToCollection: 'Añadir a mi colección',
    skip: 'Ignorar',
    doneTitle: 'Sincronización completada',
    doneSummary: (added, skipped) => `${added} foto${added !== 1 ? 's' : ''} añadida${added !== 1 ? 's' : ''}${skipped > 0 ? `, ${skipped} ignorada${skipped !== 1 ? 's' : ''}` : ''}`,
    backToTreks: 'Volver a mis rutas',
    networkError: 'Conexión perdida. Retoma la sincronización más tarde.',
