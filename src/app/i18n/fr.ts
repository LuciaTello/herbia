...
export const FR: Translations = {
  ...
  route: {
    ...
    exhausted: 'Tu as déjà découvert toutes les plantes disponibles dans cette zone ce mois-ci. Retourne dans tes balades précédentes pour chercher celles que tu n\'as pas encore trouvées, ou reviens le mois prochain pour de nouvelles espèces !',
  ...
  myTreks: {
    ...
    reactivateTrek: 'Réactiver la balade',
    completed: 'Terminée',
  ...
  login: {
    ...
    serverSlow: 'Le serveur met du temps à démarrer. Réessayez dans quelques secondes.',
  ...
  confirm: {
    ...
    rejectFriend: 'Tu veux vraiment refuser cette demande ?',
  },
  tutorials: {
    back: 'Retour à l\'accueil',
    title: 'Tutoriels',
  ...
  offline: {
    ...
    photoQueued: 'Photo enregistrée, elle sera synchronisée plus tard.',
  ...
  sync: {
    title: 'Synchroniser',
    subtitle: (n) => `${n} photo${n !== 1 ? 's' : ''} en attente`,
    syncButton: (n) => `Synchroniser ${n} photo${n !== 1 ? 's' : ''}`,
    progress: (current, total) => `Photo ${current} / ${total}`,
    identifying: 'Identification en cours...',
    addMatch: (pts) => `Ajouter (+${pts} pts)`,
    addToCollection: 'Ajouter à ma collection',
    skip: 'Ignorer',
    doneTitle: 'Synchronisation terminée',
    doneSummary: (added, skipped) => `${added} photo${added !== 1 ? 's' : ''} ajoutée${added !== 1 ? 's' : ''}${skipped > 0 ? `, ${skipped} ignorée${skipped !== 1 ? 's' : ''}` : ''}`,
    backToTreks: 'Retour à mes balades',
    networkError: 'Connexion perdue. Reprends la synchronisation plus tard.',
